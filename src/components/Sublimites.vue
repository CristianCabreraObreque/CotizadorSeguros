<template>
  <div class="container mx-auto p-4 mt-16">
      ...
      <table class="w-full table-auto border-collapse border border-gray-300 rounded-md">
        <thead>
          <tr class="bg-gray-100">
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Desde</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Hasta</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Específico</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">RC</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Cristales</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Otros</th>
        ...
        <tbody>
          <tr v-for="sublimite in sublimites" :key="sublimite.id" class="hover:bg-gray-200 transition-all even:bg-white">
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ sublimite.desde }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ sublimite.hasta }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ sublimite.especifico }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ sublimite.rc }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ sublimite.cristales }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ sublimite.otros }}</td>
            <td class="border border-gray-300 px-3 py-2 text-center">
              <button class="bg-yellow-500 hover:opacity-80 text-white font-bold py-1 px-3 rounded-md focus:outline-none focus:shadow-outline text-sm" @click="openModal(sublimite)">
                Editar
              </button>
              <button class="bg-red-500 hover:opacity-80 text-white font-bold py-1 px-3 rounded-md focus:outline-none focus:shadow-outline text-sm" @click="deleteSublimite(sublimite)">
                Eliminar
              </button>
            </td>
          </tr>
    ...
    <div class="mt-4 flex justify-end">
      <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" @click="openModal()">
        Agregar Sublímite
      </button>
    </div>
            ...
            <div class="mt-2">
              <div class="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="desdeModal" type="number" v-model.number="modalData.desde">
                </div>
                <div>
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="hastaModal">
                    Hasta
                  </label>
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="hastaModal" type="number" v-model.number="modalData.hasta">
                </div>
                <div>
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="especificoModal">
                    Específico
                  </label>
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="especificoModal" type="number" v-model.number="modalData.especifico">
                </div>
                <div>
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="rcModal">
                    RC
                  </label>
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="rcModal" type="number" v-model.number="modalData.rc">
                </div>
                <div>
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="cristalesModal">
                    Cristales
                  </label>
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="cristalesModal" type="number" v-model.number="modalData.cristales">
                </div>
                <div>
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="otrosModal">
                    Otros
                  </label>
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="otrosModal" type="number" v-model.number="modalData.otros">
                </div>
              </div>
            </div>
          </div>
