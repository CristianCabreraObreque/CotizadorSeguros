      ...
      <table class="w-full table-auto border-collapse border border-gray-300 rounded-md">
        <thead>
          <tr class="bg-gray-100">
            ...
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Tasa Anual Afecta</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Tasa Anual Exenta</th>
        ...
        <tbody>
          <tr v-for="regionFactor in regionFactors" :key="regionFactor.region" class="hover:bg-gray-200 transition-all even:bg-white">
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ regionFactor.region }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ regionFactor.tasaAnualAfecta }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ regionFactor.tasaAnualExenta }}</td>
            <td class="border border-gray-300 px-3 py-2 text-center">
              <button class="bg-yellow-500 hover:opacity-80 text-white font-bold py-1 px-3 rounded-md focus:outline-none focus:shadow-outline text-sm" @click="openModal(regionFactor)">
                Modificar
              </button>
            </td>
          </tr>
            ...
            <div class="mt-2">
              <div class="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline bg-gray-200" id="regionModal" type="text" :value="modalData.region" readonly>
                </div>
                <div>
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="tasaAnualAfectaModal">
                    Tasa Anual Afecta
                  </label>
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="tasaAnualAfectaModal" type="number" v-model.number="modalData.tasaAnualAfecta">
                </div>
                <div>
                  <label class="block text-gray-700 text-sm font-bold mb-2" for="tasaAnualExentaModal">
                    Tasa Anual Exenta
                  </label>
                  <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="tasaAnualExentaModal" type="number" v-model.number="modalData.tasaAnualExenta">
                </div>
              </div>
            </div>
          </div>
