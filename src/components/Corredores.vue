    ...
    <div class="bg-gray-100 p-4 rounded-md mb-4 shadow-sm">
      ...
      <div class="grid grid-cols-4 gap-4">
        <div>
          ...
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="rutFilter" type="text" v-model="filters.rut">
        </div>
        <div>
          <label class="block text-gray-700 text-sm font-bold mb-2" for="nombreFilter">
            Nombre
          </label>
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="nombreFilter" type="text" v-model="filters.nombre">
        </div>
        <div>
          <label class="block text-gray-700 text-sm font-bold mb-2" for="emailFilter">
            Email
          </label>
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="emailFilter" type="text" v-model="filters.email">
        </div>
        <div>
          <label class="block text-gray-700 text-sm font-bold mb-2" for="celularFilter">
            Celular
          </label>
          <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="celularFilter" type="text" v-model="filters.celular">
        </div>
      </div>
      ...
      <table class="w-full table-auto border-collapse border border-gray-300 rounded-md">
        <thead>
          <tr class="bg-gray-100">
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Rut</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Nombre</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Email</th>
            <th class="border border-gray-300 px-3 py-2 text-left font-medium text-gray-700">Celular</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="corredor in filteredCorredores" :key="corredor.rut" class="hover:bg-gray-200 transition-all even:bg-white">
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ corredor.rut }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ corredor.nombre }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ corredor.email }}</td>
            <td class="border border-gray-300 px-3 py-2 text-gray-700">{{ corredor.celular }}</td>
          </tr>
        </tbody>
      </table>
    </div>
